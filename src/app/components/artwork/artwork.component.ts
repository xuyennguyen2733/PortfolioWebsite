  ...
  artPreviews3D: ArtPreview[] = [
    {
      ...
      downloadPath: "https://drive.google.com/file/d/1o2LlOj4GUUE7DuFeem90_OkkUrpfMFBt/view?usp=sharing",
      title: "A Pink Scooter"
    },
    {
      imagePath: "images/3d-arts/ninja-lead.png",
      downloadPath: "https://drive.google.com/file/d/1LtFjYHlNEpXZfkPJgxYq1rFx2RN0GJWh/view?usp=sharing",
      title: "Ninja Lead - Who Rides the Scooter!"
    },
    {
      imagePath: "images/3d-arts/pagoda.png",
      downloadPath: "https://drive.google.com/file/d/1q6ysS2Gwie9guYgZFU4-dPXsT_-q06lE/view?usp=sharing",
      title: "A Pagoda"
    },
    {
      imagePath: "images/3d-arts/carriage.png",
      downloadPath: "https://drive.google.com/file/d/1YTdC36d23OsAIWAkJ193vso5rnlXHPvN/view?usp=sharing",
      title: "A Carriage"
    },
  ]
  
  constructor(private _sanitizer: DomSanitizer) {
    this.safeUrl = this._sanitizer.bypassSecurityTrustResourceUrl("https://www.youtube.com/embed/uGNTjFFQe0Q")
  }
...
export class PopUpImage {
  ...
  onInit() {
    if (!this.downloadPath) {
      const extension = this.imagePath.substring(this.imagePath.indexOf('.')+1);
